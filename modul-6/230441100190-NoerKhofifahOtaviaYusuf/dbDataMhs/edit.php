...
<body style="background-image:url('bgr.jpg'); background-size: 100% ;">
 <center>
    ...
    <form method="post" action="">
        <table>
            ...
            <tr>
                <td>Jenis Kelamin</td>
                <td>
                    <input type="radio" name="Jenis_kelamin" value="laki-laki" <?php if ($d['Jenis_kelamin'] == 'laki-laki') echo 'checked'; ?>> laki-laki <br>
