...
function editStudent($nim, $nama, $alamat, $Prodi, $angkatan) {
    $_SESSION['students'][$nim] = [
        'nama' => $nama,
        'alamat' => $alamat,
        'Prodi' => $Prodi,
...
if (isset($_POST['action'])) {
    if ($_POST['action'] == 'Tambah') {
        ...
        editStudent($_SESSION['edit_nim'], $_POST['nama'], $_POST['alamat'], $_POST['Prodi'], $_POST['angkatan']);
...
<body>
    ...
    <form method="post">
        ...
        Prodi: <input type="text" name="Prodi" value="<?= isset($_SESSION['edit_nim']) ? $_SESSION['students'][$_SESSION['edit_nim']]['Prodi'] : '' ?>" required><br>
